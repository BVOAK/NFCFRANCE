...
$vcard_fields = [
    ...
    'profile_picture' => get_post_meta($vcard_id, 'profile_picture', true) ?: (function_exists('get_field') ? get_field('profile_picture', $vcard_id) : ''),
    'cover_image' => get_post_meta($vcard_id, 'cover_image', true) ?: (function_exists('get_field') ? get_field('cover_image', $vcard_id) : ''),
