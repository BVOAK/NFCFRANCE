...
// Variables pour JavaScript (selon standard)
$vcard_edit_data = [
    'vcard_id' => $vcard_id,
    'user_id' => $user_id,
...
wp_enqueue_style('vcard-edit-css', $plugin_url . 'css/dashboard/vcard-edit.css', [], '1.0.0');
wp_enqueue_style('cropper-css', 'https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.5.12/cropper.min.css');

wp_enqueue_script('cropper-js', 'https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.5.12/cropper.min.js', ['jquery'], '1.5.12', true);
wp_enqueue_script('vcard-editor', $plugin_url . 'js/dashboard/vcard-editor.js', ['jquery', 'cropper-js'], '1.0.0', true);
wp_localize_script('vcard-editor', 'vcardEditConfig', $vcard_edit_data);
                ...
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <div id="vcard-preview" class="vcard-preview-frame">
                            <!-- Preview généré dynamiquement par JavaScript -->
                            <div class="preview-loading text-center py-4">
                                <i class="fas fa-spinner fa-spin mb-2"></i>
                                <p class="text-muted">Chargement du preview...</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="editor-section card mb-4">
                    <div class="card-header bg-light">
                        <div class="section-header">
                            ...
                            <p class="text-muted mb-0 small">Vos informations de base et photo de profil</p>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="section-content">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="upload-zone" id="profile-upload-zone">
...
<script>
// Configuration JavaScript (UNIQUEMENT variables)
const vcardEditConfig = <?= json_encode($vcard_edit_data, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) ?>;
</script>
