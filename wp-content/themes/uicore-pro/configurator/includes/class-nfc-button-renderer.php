...
class NFC_Button_Renderer
{
    ...
    private function render_single_button($config, $atts)
    {
        ...
        if (!empty($atts['animation'])) {
            $elementor_classes[] = 'elementor-animation-flip';
        }
        ...
        ?>
        <div
            class="nfc-product-buttons nfc-single-button nfc-layout-<?php echo esc_attr($atts['layout']); ?> <?php echo esc_attr($atts['class']); ?>">
            <?php if ($primary_action === 'configurator'): ?>
                <a href="<?php echo esc_url($config['configurator_url']); ?>"
                    ...
                    data-product-id="<?php echo esc_attr($product_id); ?>" data-action="configurator"
                    ...
                    <span class="elementor-button-content-wrapper">
                        <span class="ui-btn-anim-wrapp d-flex">
                            <span class="elementor-button-text "><?php echo esc_html($button_props['text']); ?></span>
                        </span>
                    </span>
                </a>
            <?php elseif ($primary_action === 'files'): ?>
                <div>
                    <button type="button" class="<?php echo implode(' ', $elementor_classes); ?> nfc-addtocart-button"
                        data-product-id="<?php echo esc_attr($product_id); ?>" data-action="add-with-files" data-nfc-button="files">
                        <img src="<?php echo get_template_directory_uri() ?>/assets/img/add-to-cart.svg" />
                        <span class="elementor-button-content-wrapper">
                            <span class="ui-btn-anim-wrapp d-flex">
                                <span class="elementor-button-text nfc-btn-text">
                                    <span><?php echo esc_html($button_props['text']); ?></span>
                                </span>
                            </span>
                        </span>
                    ...
                    <!-- <small><i><?php echo esc_html__('Envoi des fichiers d\'impression à effecuter post-achat', 'nfc-configurator'); ?></i></small> -->
                </div>
            <?php endif; ?>
        </div>
        <?php
    ...
    private function render_dual_buttons($config, $atts)
    {
        ...
        ?>
        <div
            class="nfc-product-buttons nfc-dual-buttons nfc-layout-<?php echo esc_attr($atts['layout']); ?> <?php echo esc_attr($atts['class']); ?>">
            ...
            <a href="<?php echo esc_url($config['configurator_url']); ?>"
                ...
                <span class="elementor-button-content-wrapper">
                    <span class="ui-btn-anim-wrapp d-flex">
                        <span class="elementor-button-text "><?php echo esc_html($primary_props['text']); ?></span>
                    </span>
                </span>
            </a>
            ...
            <div>
                <button type="button" class="<?php echo implode(' ', $elementor_classes); ?> nfc-addtocart-button"
                    ...
                    <span class="elementor-button-content-wrapper">
                        <span class="ui-btn-anim-wrapp d-flex">
                            <span class="elementor-button-text nfc-btn-text">
                                <span><?php echo esc_html($secondary_props['text']); ?></span>
                            </span>
                        </span>
                    </span>
                    <!-- <span class="nfc-btn-loading" style="display: none;">
    ...
    private function get_button_properties($action_type, $config)
    {
        switch ($action_type) {
            ...
            case 'files':
                return [
                    'text' => __('Ajout au panier', 'nfc-configurator'),
